/*!
 * @file            GParserJson_parseNumber.c
...
int GParserJson_parseNumber(GParserJson_State *p_state_inout, GParserJson_Value **pp_value_out)
{
    ...
    p_value->type = GPARSERJSON_VALUE_TYPE_NUMBER;
