...
int GParserJson_loadUInt(GParserJson_State *p_state_in, const char *p_key_in, unsigned int *p_value_out)
{
    ...
    *p_value_out = (unsigned int)p_value->numberValue;
    return GCONST_TRUE;
}