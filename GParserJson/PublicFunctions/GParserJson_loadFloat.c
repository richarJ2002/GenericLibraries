...
int GParserJson_loadFloat(GParserJson_State *p_state_in, const char *p_key_in, float *p_value_out)
{
    ...
    *p_value_out = (float)p_value->numberValue;
    return GCONST_TRUE;
}